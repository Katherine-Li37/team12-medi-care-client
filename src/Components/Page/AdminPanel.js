    ...
    onSumbit = () => {
        Axios({
          ...
          data: {
            ...
            patientName: this.state.userSelected.firstName + ' ' + this.state.userSelected.lastName,
            ...
            <React.Fragment>
                ...
                <div className='contact-form-wraper'>
                    <div className='container new-container'>
                        ...
                        {this.state.userSelected && this.state.clinicSelected && this.state.displayedAppointments.length &&
                            <div className='container new-container'> 
